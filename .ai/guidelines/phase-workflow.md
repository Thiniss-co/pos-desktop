...
| 4 | Local sale / sync queue | Completing a sale locally, sync queue implementation (states, idempotency, conflict/rejection review, worker pause), background sync process. |
